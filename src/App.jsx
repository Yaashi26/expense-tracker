    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 mb-8">
        ...
        <div className="h-64 flex items-end justify-center gap-10">
          <div className="w-28 md:w-36 bg-indigo-600 rounded-t-xl" style={{ height: `${(incomeTotal / maxAmount) * 100}%` }}></div>
          <div className="w-28 md:w-36 bg-indigo-300 rounded-t-xl" style={{ height: `${(expenseTotal / maxAmount) * 100}%` }}></div>
        </div>
                    ...
                    <td className="py-4">
                      <div className="flex items-center gap-3 text-lg">
                        ...
                        <button
                          onClick={() =>
                            setTransactions(
                              transactions.filter((transaction) => transaction.id !== t.id)
                            )
                          }
